...
import com.hxo.nhm.web.enums.CategoryGender;
...
public class MajorCategory implements Serializable {
	...
	public CategoryGender getCategoryGender() {
		return categoryGender;
	}

	public void setCategoryGender(CategoryGender categoryGender) {
	...
	public int hashCode() {
		...
		result = prime * result + ((categoryGender == null) ? 0 : categoryGender.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (additionalStatus != other.additionalStatus)
			return false;
		if (categoryGender != other.categoryGender)
			return false;
		if (description == null) {
